			...
			<div className="form">
				...
				<div className="delivery-calendar-div">
					<div className="delivery-text">
						...
						<p>
							{' '}
							Use this form to book your order. Select the date you want your
							cake to be picked up or delivered.
						</p>
						<p>
							Date selected:{' '}
				...
				>
					...
					<input className="btn-main" type="submit" value="Submit your Order" />
				</form>
			</div>
		</div>
	);
